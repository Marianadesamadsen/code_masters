...
#BSUB -o /zhome/5e/a/152106/code_masters/jobs/output/train/samemesh4nn_3mp.out
#BSUB -e /zhome/5e/a/152106/code_masters/jobs/output/train/samemesh4nn_3mp.err
...
python -m neural_lam.train_model \
    ...
    --epochs 100 \
    --processor_layers 3 \
    --logger_run_name "train 3mp same mesh 4 nearest neighbor" 
