...
#BSUB -o /zhome/5e/a/152106/code_masters/jobs/output/start_up_tests/in_memory_nw_2.out
#BSUB -e /zhome/5e/a/152106/code_masters/jobs/output/start_up_tests/in_memory_nw_2.err
...
python -m neural_lam.train_model \
    ...
    --epochs 100 \
    --processor_layers 1 \
    --logger_run_name "in_memory_nw_2" \
    --batch_size 8 \
