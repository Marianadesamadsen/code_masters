...
#BSUB -o /zhome/5e/a/152106/code_masters/jobs/output/start_up_tests/chunking_3_bs_32.out
#BSUB -e /zhome/5e/a/152106/code_masters/jobs/output/start_up_tests/chunking_3_bs_32.err
...
python -m neural_lam.train_model \
    ...
    --epochs 100 \
    --processor_layers 1 \
    --logger_run_name "chunking_3_bs_32" \
    --batch_size 32 \
