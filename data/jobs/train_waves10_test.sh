...
#BSUB -o /zhome/5e/a/152106/code_masters/jobs/output/train/waves10_10h_50epochs.out
#BSUB -e /zhome/5e/a/152106/code_masters/jobs/output/train/waves10_10h_50epochs.err
...
python -m neural_lam.train_model \
    ...
    --epochs 50 \
    --processor_layers 1 \
    --logger_run_name "train 10 waves 10 hours 50 epochs" \
    --batch_size 4 \
