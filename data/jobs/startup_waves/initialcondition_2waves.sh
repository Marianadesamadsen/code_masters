...
### -- set the job Name --
#BSUB -J initialcondition_2waves
...
#BSUB -o /zhome/5e/a/152106/code_masters/jobs/output/start_up_tests/initialcondition_2waves.out
#BSUB -e /zhome/5e/a/152106/code_masters/jobs/output/start_up_tests/initialcondition_2waves.err
...
python -m neural_lam.train_model \
    ...
    --epochs 100 \
    --processor_layers 1 \
    --logger_run_name "initialcondition_2waves" \
    --batch_size 32 \
