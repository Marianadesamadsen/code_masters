...
def plot_latlon_snapshots_best_worst_rmse_mp(
    ds_geo_dir,
    raw_dir,
    result_dir,
    mp_step,
    ...
    metric_label = {
        ...
        "energy_rel_error": "relative energy error",
    ...
    selected = [
        (best_idx, f"Best {metric_label}"),
        (worst_idx, f"Worst {metric_label}"),
    ]
    ...
    for sample_idx, group_label in selected:
        ...
        for ridx in rollout_indices:
            fields = [
                ...
                ("Error", target[ridx]-pred[ridx] , "coolwarm", error_norm),
            ]
    ...
    fig.suptitle(
        f"Best and worst {metric_label} trajectories projected to latitude-longitude",
        fontsize=22,
    )
    ...
    out_path = os.path.join(
        plot_dir,
        f"best_worst_{metric_key}_latlon_snapshots_mp{mp_step}.png",
    )
...
if __name__ == "__main__":
    ...
    raw_dir = (
        ...
        f"test_mp{mp_step}_results_new.zarr"
    )
    ...
    plot_latlon_snapshots_best_worst_rmse_mp(
