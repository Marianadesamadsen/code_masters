...
#BSUB -o GNN_training/one_wave/different_AR/output/train_75_test_100.out
#BSUB -e GNN_training/one_wave/different_AR/output/train_75_test_100.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    ...
    --save_eval_to_zarr_path "GNN_training/one_wave/different_AR/test_75_results_100.zarr"
