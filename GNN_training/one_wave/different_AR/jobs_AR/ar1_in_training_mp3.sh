...
#BSUB -oo GNN_training/one_wave/different_AR/outputs/ar1_in_training_mp3.out
#BSUB -ee GNN_training/one_wave/different_AR/outputs/ar1_in_training_mp3.err
...
python -m neural_lam.train_model \
    ...
    --epochs 100 \
    --processor_layers 3 \
    --logger_run_name "ar1_in_training_mp3" \
    --batch_size 32 \
