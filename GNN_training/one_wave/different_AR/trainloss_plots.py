...
df_rel_energy_1 = pd.read_csv(
    "GNN_training/one_wave/different_AR/AR_validationlossenergy.csv"
)

df_train_loss = pd.read_csv(
    "GNN_training/one_wave/different_AR/AR_trainingloss.csv"
)

df_val_loss_1 = pd.read_csv(
    "GNN_training/one_wave/different_AR/AR_validationlossmean.csv"
)

data_sizes = ["75_AR5","75"]
...
plt.suptitle(
    "Loss curves for different AR rollouts in training",
    fontsize=20,
)
...
plt.savefig(
    "GNN_training/one_wave/different_AR/all_results_plot/val_loss_rollout1_moving_average.png",
    dpi=300,
)
...
plt.suptitle(
    "Training loss curves for different AR rollouts in training",
    fontsize=20,
)
...
plt.savefig(
    "GNN_training/one_wave/different_AR/all_results_plot/train_loss_rollout1_moving_average.png",
    dpi=300,
)
