...
#BSUB -o GNN_training/one_wave/different_training_size/output/new_dt.out
#BSUB -e GNN_training/one_wave/different_training_size/output/new_dt.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    --config_path GNN_training/one_wave/yaml_files/config_wave_newdt.yaml \
    --graph GNN_training/graphs/gsub4_msub4_nn1 \
    --loss mse \
    --seed 42 \
    --num_workers 0 \
    --processor_layers 1 \
    --logger_run_name new_dt \
    --batch_size 32 \
