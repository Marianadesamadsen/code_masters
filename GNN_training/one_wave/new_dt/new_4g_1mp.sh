...
#BSUB -o GNN_training/one_wave/different_training_size/output/newsetup_4g_1mp.out
#BSUB -e GNN_training/one_wave/different_training_size/output/newsetup_4g_1mp.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    ...
    --num_workers 0 \
    --processor_layers 1 \
    --logger_run_name newsetup_4g_1mp \
    --batch_size 32 \
