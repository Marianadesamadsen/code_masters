...
#BSUB -o GNN_training/one_wave/different_training_size/output/new_dt8.out
#BSUB -e GNN_training/one_wave/different_training_size/output/new_dt8.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    --config_path GNN_training/one_wave/yaml_files/config_wave_8dt.yaml \
    --graph GNN_training/graphs/gsub4_msub4_nn1 \
    --loss mse \
    --seed 42 \
    --num_workers 0 \
    --processor_layers 1 \
    --logger_run_name new_dt8 \
    --batch_size 32 \
