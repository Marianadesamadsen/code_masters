...
#BSUB -o GNN_training/one_wave/different_training_size/output/new_dt20.out
#BSUB -e GNN_training/one_wave/different_training_size/output/new_dt20.err
# -- end of LSF options --
