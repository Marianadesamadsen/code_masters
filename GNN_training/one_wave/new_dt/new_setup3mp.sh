...
#BSUB -o GNN_training/one_wave/different_training_size/output/newsetup_3mp.out
#BSUB -e GNN_training/one_wave/different_training_size/output/newsetup_3mp.err
# -- end of LSF options --
