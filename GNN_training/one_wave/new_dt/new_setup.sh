...
#BSUB -o GNN_training/one_wave/different_training_size/output/newsetup.out
#BSUB -e GNN_training/one_wave/different_training_size/output/newsetup.err
# -- end of LSF options --
