...
#BSUB -o GNN_training/one_wave/different_training_size/output/train_50.out
#BSUB -e GNN_training/one_wave/different_training_size/output/train_50.err
# -- end of LSF options --
