...
#BSUB -o GNN_training/one_wave/different_training_size/output/train_10.out
#BSUB -e GNN_training/one_wave/different_training_size/output/train_10.err
# -- end of LSF options --
