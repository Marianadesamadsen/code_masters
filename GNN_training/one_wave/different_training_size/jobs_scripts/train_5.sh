...
#BSUB -o GNN_training/one_wave/different_training_size/output/train_5.out
#BSUB -e GNN_training/one_wave/different_training_size/output/train_5.err
# -- end of LSF options --
