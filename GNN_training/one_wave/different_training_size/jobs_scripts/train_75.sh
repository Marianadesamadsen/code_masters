...
#BSUB -o GNN_training/one_wave/different_training_size/output/train_75_AR5.out
#BSUB -e GNN_training/one_wave/different_training_size/output/train_75_AR5.err
# -- end of LSF options --
