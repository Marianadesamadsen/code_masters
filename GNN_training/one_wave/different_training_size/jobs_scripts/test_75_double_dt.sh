...
#BSUB -o GNN_training/one_wave/different_training_size/output/train_75_test_doubledt.out
#BSUB -e GNN_training/one_wave/different_training_size/output/train_75_test_doubledt.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    ...
    --epochs 200 \
    --processor_layers 1 \
    --logger_run_name test_75_doubledt \
    --batch_size 1 \
    ...
    --ar_steps_eval "20" \
    --save_eval_to_zarr_path "GNN_training/one_wave/different_training_size/test_75_results_double_dt.zarr"
