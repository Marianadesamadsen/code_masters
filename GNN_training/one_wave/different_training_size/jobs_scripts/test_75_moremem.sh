...
#BSUB -o GNN_training/one_wave/different_training_size/output/train_75_test_moremem.out
#BSUB -e GNN_training/one_wave/different_training_size/output/train_75_test_moremem.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    ...
    --epochs 200 \
    --processor_layers 1 \
    --logger_run_name test_75_moremem \
    --batch_size 32 \
    ...
    --ar_steps_eval "40" \
    --save_eval_to_zarr_path "GNN_training/one_wave/different_training_size/test_75_results_new_moremem.zarr"
