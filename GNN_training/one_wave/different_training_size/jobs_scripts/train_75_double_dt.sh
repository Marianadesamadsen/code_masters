...
#BSUB -o GNN_training/one_wave/different_training_size/output/train_75_doubledt.out
#BSUB -e GNN_training/one_wave/different_training_size/output/train_75_doubledt.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    ...
    --num_workers 0 \
    --processor_layers 1 \
    --logger_run_name train_75_doubledt \
    --batch_size 32 \
