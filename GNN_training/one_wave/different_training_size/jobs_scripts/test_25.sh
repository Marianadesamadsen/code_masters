...
#BSUB -o GNN_training/one_wave/different_training_size/output/train_25_test.out
#BSUB -e GNN_training/one_wave/different_training_size/output/train_25_test.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    ...
    --epochs 200 \
    --processor_layers 1 \
    --logger_run_name test_25 \
    --precompute_in_memory \
    --batch_size 32 \
    --logger-project different_training_size_test \
    --eval "test" \
    --load "saved_models/old_dataset/train_25/min_val_loss-epoch=233-val_mean_loss=0.000216.ckpt" \
    --ar_steps_eval "30" \
