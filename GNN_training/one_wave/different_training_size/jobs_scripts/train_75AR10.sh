...
#BSUB -o GNN_training/one_wave/different_training_size/output/train_75_AR10.out
#BSUB -e GNN_training/one_wave/different_training_size/output/train_75_AR10.err
# -- end of LSF options --
