...
#BSUB -o GNN_training/one_wave/different_training_size/output/train_1_test.out
#BSUB -e GNN_training/one_wave/different_training_size/output/train_1_test.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    ...
    --epochs 200 \
    --processor_layers 1 \
    --logger_run_name test_1 \
    --batch_size 32 \
    --logger-project different_training_size_test \
    --precompute_in_memory \
    --eval "test" \
    --load "saved_models/train_1/min_val_loss-epoch=304-val_mean_loss=0.013022-v1.ckpt" \
    --ar_steps_eval "20" \
