...
plot_animations.plot_results(
    ...
    raw_dirs=[
        "GNN_training/one_wave/different_training_size/test_10_results.zarr",
        "GNN_training/one_wave/different_training_size/test_25_results.zarr",
        "GNN_training/one_wave/different_training_size/test_50_results.zarr",
        "GNN_training/one_wave/different_training_size/test_100_results.zarr",
    ],
    plot_dir=plot_dir,
    anim_dir=anim_dir,
    generations=4,
    training_size_labels=[
        ...
        "Train size: 25 waves",
        "Train size: 50 waves",
        "Train size: 100 waves",
    ],
    rolloutidx=150,
    azim=135,
    elev=30,
    plot_animations_rollout=False
)
