...
#BSUB -o GNN_training/one_wave/different_mesh_size/output/test_40dt_AR_2.out
#BSUB -e GNN_training/one_wave/different_mesh_size/output/test_40dt_AR_2.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    ...
    --epochs 200 \
    --processor_layers 1 \
    --logger_run_name test_40dt_AR_2 \
    --batch_size 1 \
    --ar_steps_train 2\
    ...
    --ar_steps_eval "10" \
    --val_steps_to_log 1\
    --save_eval_to_zarr_path "GNN_training/one_wave/different_mesh_size/final_results/test_40dt_AR_2.zarr" \
    --test_time_stride 10 \
    --test_time_jump 40
