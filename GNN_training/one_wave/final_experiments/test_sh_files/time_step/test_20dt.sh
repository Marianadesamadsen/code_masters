...
#BSUB -o GNN_training/one_wave/different_mesh_size/output/test_20dt.out
#BSUB -e GNN_training/one_wave/different_mesh_size/output/test_20dt.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    ...
    --ar_steps_eval "20" \
    --val_steps_to_log 1\
    --save_eval_to_zarr_path "GNN_training/one_wave/different_mesh_size/final_results/test_20dt.zarr" \
    --test_time_stride 10  \
    --test_time_jump 20
