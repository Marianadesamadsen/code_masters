...
#BSUB -o GNN_training/one_wave/different_mesh_size/output/test_90dt.out
#BSUB -e GNN_training/one_wave/different_mesh_size/output/test_90dt.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    ...
    --epochs 200 \
    --processor_layers 1 \
    --logger_run_name test_90dt \
    --batch_size 1 \
    --logger-project different_training_size_test \
    --precompute_in_memory \
    --eval "test" \
    --load "saved_models/dt90_mp1/val_loss_unroll1-epoch=564-val_loss_unroll1=0.109009.ckpt" \
    --ar_steps_eval "5" \
    --val_steps_to_log 1\
    --save_eval_to_zarr_path "GNN_training/one_wave/different_mesh_size/final_results/test_90dt.zarr" \
    --test_time_stride 10  \
    --test_time_jump 90
