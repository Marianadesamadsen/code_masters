...
#BSUB -o GNN_training/one_wave/different_mesh_size/output/dt40_mp1_AR2.out
#BSUB -e GNN_training/one_wave/different_mesh_size/output/dt40_mp1_AR2.err
# -- end of LSF options --
