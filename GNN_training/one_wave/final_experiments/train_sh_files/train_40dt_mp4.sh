...
#BSUB -o GNN_training/one_wave/different_mesh_size/output/dt40_mp4.out
#BSUB -e GNN_training/one_wave/different_mesh_size/output/dt40_mp4.err
# -- end of LSF options --
