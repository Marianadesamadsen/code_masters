...
#BSUB -o GNN_training/one_wave/different_mesh_size/output/dt100_mp1.out
#BSUB -e GNN_training/one_wave/different_mesh_size/output/dt100_mp1.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    --config_path GNN_training/one_wave/yaml_files/config_full_data_90.yaml \
