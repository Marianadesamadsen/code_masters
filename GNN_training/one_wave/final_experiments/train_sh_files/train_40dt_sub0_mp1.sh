...
#BSUB -o GNN_training/one_wave/different_mesh_size/output/dt40_mp1_sub0_cont.out
#BSUB -e GNN_training/one_wave/different_mesh_size/output/dt40_mp1_sub0_cont.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    ...
    --processor_layers 1 \
    --logger_run_name dt40_mp1_sub0_cont \
    --batch_size 32 \
    ...
    --max_steps 800000 \
    --lr 0.001 \
    --load saved_models/dt40_mp1_sub0/step-step=540000.ckpt\
    --train_time_jump 40 \
    --test_time_jump 40 \
    --val_time_jump 40
