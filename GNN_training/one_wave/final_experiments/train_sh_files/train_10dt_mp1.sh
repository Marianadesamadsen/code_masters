...
#BSUB -o GNN_training/one_wave/different_mesh_size/output/dt10_mp1_cont2.out
#BSUB -e GNN_training/one_wave/different_mesh_size/output/dt10_mp1_cont2.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    ...
    --processor_layers 1 \
    --logger_run_name dt10_mp1_cont2 \
    --batch_size 32 \
    ...
    --max_steps 800000 \
    --lr 0.001 \
    --load "saved_models/dt10_mp1_cont/step-step=540000.ckpt" \
    --train_time_jump 10 \
    --test_time_jump 10 \
    --val_time_jump 10
