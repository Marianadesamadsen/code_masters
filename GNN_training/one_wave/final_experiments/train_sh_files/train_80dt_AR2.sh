...
#BSUB -o GNN_training/one_wave/different_mesh_size/output/dt80_mp1_AR2.out
#BSUB -e GNN_training/one_wave/different_mesh_size/output/dt80_mp1_AR2.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    ...
    --ar_steps_train 2 \
    --train_time_jump 80 \
    --load saved_models/dt80_mp1_cont2/step-step=800000.ckpt\
    --test_time_jump 80 \
    --val_time_jump 80 \
    --ar_steps_eval 3 
