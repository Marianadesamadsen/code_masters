...
#BSUB -o GNN_training/one_wave/different_mesh_size/output/dt20_mp1_cont2.out
#BSUB -e GNN_training/one_wave/different_mesh_size/output/dt20_mp1_cont2.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    ...
    --processor_layers 1 \
    --logger_run_name dt20_mp1_cont2 \
    --batch_size 32 \
    ...
    --max_steps 800000 \
    --lr 0.001 \
    --load "saved_models/dt20_mp1_cont/step-step=540000.ckpt" \
    --train_time_jump 20 \
    --test_time_jump 20 \
    --val_time_jump 20
