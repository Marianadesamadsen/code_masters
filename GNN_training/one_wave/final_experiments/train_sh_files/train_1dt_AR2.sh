...
#BSUB -o GNN_training/one_wave/different_mesh_size/output/dt1_mp1_AR2.out
#BSUB -e GNN_training/one_wave/different_mesh_size/output/dt1_mp1_AR2.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    ...
    --max_steps 130000 \
    --load saved_models/dt1_mp1_cont/step-step=800000.ckpt\
    --lr 0.001 \
    --train_time_jump 1 \
    --test_time_jump 1 \
    --val_time_jump 1
