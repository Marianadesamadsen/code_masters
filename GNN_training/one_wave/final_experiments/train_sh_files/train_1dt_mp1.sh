...
#BSUB -o GNN_training/one_wave/different_mesh_size/output/dt1_mp1_cont.out
#BSUB -e GNN_training/one_wave/different_mesh_size/output/dt1_mp1_cont.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    ...
    --max_steps 800000 \
    --lr 0.001 \
    --load saved_models/dt1_mp1/step-step=540000.ckpt\
    --train_time_jump 1 \
    --test_time_jump 1 \
    --val_time_jump 1
