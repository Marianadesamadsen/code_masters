...
#BSUB -o GNN_training/one_wave/different_mesh_size/output/dt40_mp1_sub1_nn91_AR2.out
#BSUB -e GNN_training/one_wave/different_mesh_size/output/dt40_mp1_sub1_nn91_AR2.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    ...
    --processor_layers 1 \
    --logger_run_name dt40_mp1_sub1_nn91_AR2 \
    --batch_size 32 \
