...
#BSUB -o GNN_training/one_wave/different_mesh_size/output/dt40_mp1.out
#BSUB -e GNN_training/one_wave/different_mesh_size/output/dt40_mp1.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    ...
    --graph GNN_training/graphs/gsub4_msub1_nn_g2m61_m2g4 \
    --loss mse \
    --seed 42 \
    --num_workers 0 \
    --val_steps_to_log 1 2\
    --processor_layers 1 \
    --logger_run_name dt40_mp1_sub1 \
    --batch_size 32 \
