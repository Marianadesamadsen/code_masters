...
#BSUB -o GNN_training/one_wave/different_mesh_size/output/dt40_mp1_corrected.out
#BSUB -e GNN_training/one_wave/different_mesh_size/output/dt40_mp1_corrected.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    ...
    --graph GNN_training/graphs/gsub4_msub2_nn_g2m19_m2g4_corrected \
    --loss mse \
    --seed 42 \
    --num_workers 0 \
    --val_steps_to_log 1 2\
    --processor_layers 1 \
    --logger_run_name dt40_mp1_corrected \
    --batch_size 32 \
