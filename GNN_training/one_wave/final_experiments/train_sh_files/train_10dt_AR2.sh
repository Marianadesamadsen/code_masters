...
#BSUB -o GNN_training/one_wave/different_mesh_size/output/dt10_mp1_AR2.out
#BSUB -e GNN_training/one_wave/different_mesh_size/output/dt10_mp1_AR2.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    ...
    --max_steps 1300000 \
    --lr 0.001 \
    --load saved_models/dt10_mp1_cont2/step-step=800000.ckpt \
    --train_time_jump 10 \
    --test_time_jump 10 \
    --val_time_jump 10
