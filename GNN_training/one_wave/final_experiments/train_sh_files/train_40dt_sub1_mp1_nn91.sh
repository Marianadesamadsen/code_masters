...
### -- set the job Name --
#BSUB -J dt40_mp1_sub1_nn91_cont
...
#BSUB -o GNN_training/one_wave/different_mesh_size/output/dt40_mp1_sub1_nn91_cont.out
#BSUB -e GNN_training/one_wave/different_mesh_size/output/dt40_mp1_sub1_nn91_cont.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    ...
    --processor_layers 1 \
    --logger_run_name dt40_mp1_sub1_nn91_cont \
    --batch_size 32 \
    --logger-project different_training_size \
    --precompute_in_memory \
    --checkpoint_every_n_steps 20000 \
    --max_steps 800000 \
    --load saved_models/dt40_mp1_sub1_nn91/step-step=540000.ckpt\
    --lr 0.001 \
    --train_time_jump 40 \
    --test_time_jump 40 \
    --val_time_jump 40
