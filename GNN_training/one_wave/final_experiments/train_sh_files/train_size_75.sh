...
#BSUB -o GNN_training/one_wave/different_mesh_size/output/dt40_train_size_75.out
#BSUB -e GNN_training/one_wave/different_mesh_size/output/dt40_train_size_75.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    --config_path GNN_training/one_wave/yaml_files/yamlfiles_for_trainsize/config_wave_75_train.yaml \
    ...
    --processor_layers 1 \
    --logger_run_name dt40_train_size_75 \
    --batch_size 32 \
