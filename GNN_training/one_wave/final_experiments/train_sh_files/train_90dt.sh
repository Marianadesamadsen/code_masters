...
#BSUB -o GNN_training/one_wave/different_mesh_size/output/dt90_mp1.out
#BSUB -e GNN_training/one_wave/different_mesh_size/output/dt90_mp1.err
# -- end of LSF options --
