...
#BSUB -o GNN_training/one_wave/different_mesh_size/output/dt40_mp2_cont.out
#BSUB -e GNN_training/one_wave/different_mesh_size/output/dt40_mp2_cont.err
# -- end of LSF options --
