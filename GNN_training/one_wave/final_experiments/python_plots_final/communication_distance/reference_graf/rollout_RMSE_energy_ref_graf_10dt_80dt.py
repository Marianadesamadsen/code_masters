...
RUN_DIRS = {
    "10dt": {"label": r"$10\Delta t$", "result_dir": "test_10dt_2", "dt_scale": 10,"line":"-","color":"red"},
    "10dt sub 1": {"label": r"$10\Delta t$ sub 1", "result_dir": "test_10dt_sub1", "dt_scale": 10,"line":"--","color":"red"},
    "40dt": {"label": r"$40\Delta t$", "result_dir": "test_40dt_2", "dt_scale": 40,"line":"-","color":"green"},
    "40dt sub 1": {"label": r"$40\Delta t$ sub 1", "result_dir": "test_40dt_sub1", "dt_scale": 40,"line":"--","color":"green"},
     "80dt": {"label": r"$80\Delta t$", "result_dir": "test_80dt_2", "dt_scale": 80,"line":"-","color":"blue"},
    "80dt sub 1": {"label": r"$80\Delta t$ sub 1", "result_dir": "test_80dt_sub1_cont", "dt_scale": 80,"line":"--","color":"blue"},
}
...
def compute_mean_percentage_improvements():
    ...
    for base_key, sub1_key in pairs:
        ...
        rmse_improvement = 100 * (base_rmse - sub1_rmse) / base_rmse
        mean_rmse_improvement = np.mean(rmse_improvement)
        ...
        energy_improvement = 100 * (base_energy - sub1_energy) / base_energy
        mean_energy_improvement = np.mean(energy_improvement)

        print(f"{base_key} -> {sub1_key}")
        print(f"  Mean RMSE improvement:          {mean_rmse_improvement:.2f}%")
        print(f"  Mean energy error improvement: {mean_energy_improvement:.2f}%")
        print()
...
def plot_rollout_rmse_energy():
    ...
    out_path = RESULTS_DIR / "rmse_energy_graf_reference_10dt80dt.png"
