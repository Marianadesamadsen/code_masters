...
ENERGY_REL_ERROR_FILE = "test_energy_rel_error_sem_reference_per_sample.csv"
...
def compute_mean_percentage_improvements():
    ...
    data_energy_rel = load_metric(ENERGY_REL_ERROR_FILE)
...
def plot_rollout_rmse_energy():
    ...
    for dt_key, cfg in RUN_DIRS.items():
        ...
        # Optional persistence SEM energy baseline
        if dt_key == "-1":
            ...
            x_pers_energy = energy_rollouts * dt_scale * DT_BASE
