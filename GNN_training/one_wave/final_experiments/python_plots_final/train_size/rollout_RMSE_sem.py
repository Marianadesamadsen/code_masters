...
RESULTS_DIR = Path("GNN_training/one_wave/different_mesh_size/final_results_plots/train_size/final")
...
RUN_DIRS = {
    "75": {"label": r"Train 75", "result_dir": "test_40dt_75", "dt_scale": 40},
    "100": {"label": r"Train 100", "result_dir": "test_40dt_2", "dt_scale": 40},
    "125": {"label": r"Train 125", "result_dir": "test_40dt_125", "dt_scale": 40},
}
...
def plot_rollout_rmse_energy():
    ...
    for dt_key, cfg in RUN_DIRS.items():
        ...
        # SEM-reference relative energy error
