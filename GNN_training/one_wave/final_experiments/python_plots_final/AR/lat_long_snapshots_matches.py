...
RUNS = {
    # "1dt": {
    #     "label": r"$1\Delta t$: $\hat{u}_{t+40\Delta t}$",
    #     "label2": r"$1\Delta t$: $u_{t+40\Delta t}$",
    #     "zarr_path": BASE_DIR / "test_1dt.zarr",
    # },
    # "10dt": {
    #     "label": r"$10\Delta t$: $\hat{u}_{t+4\Delta t}$",
    #     "label2": r"$10\Delta t$: $u_{t+4\Delta t}$",
    #     "zarr_path": BASE_DIR / "test_10dt_AR2.zarr",
    # },
    "20dt": {
        "label": r"$20\Delta t$: $\hat{u}_{t+2\Delta t}$",
        "label2": r"$20\Delta t$: $u_{t+2\Delta t}$",
        "zarr_path": BASE_DIR / "test_20dt_AR.zarr",
    },
    "40dt": {
        "label": r"$40\Delta t$: $\hat{u}_{t+\Delta t}$",
        "label2": r"$40\Delta t$: $u_{t+\Delta t}$",
        "zarr_path": BASE_DIR / "test_40dt_AR.zarr",
    },
    # "80dt": {
    #     "label": r"$\hat{u}_{t+1}$",
    #     "label2": r"$80\Delta t$: $u_{t+1}$",
    #     "zarr_path": BASE_DIR / "test_80dt.zarr",
    # },
}
...
save_name = "latlon_heatmap_all_onestep_prediction.png"
...
def main():
    ...
    err_vmax = 0.5#max(np.nanmax(np.abs(v)) for v in all_errors)
    err_vmin = -err_vmax
    ...
    fig.suptitle(
        "Prediction heatmaps across different rollouts",
        fontsize=22,
    )
