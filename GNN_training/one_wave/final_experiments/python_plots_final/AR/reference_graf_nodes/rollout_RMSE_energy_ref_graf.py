...
def compute_mean_percentage_improvements():
    ...
    print("\nPercentage improvement from baseline to sub1")
    print("-" * 70)
    ...
    for base_key, sub1_key in pairs:
        ...
        one_step_rmse_improvement = rmse_improvement[0]
        ...
        one_step_energy_improvement = energy_improvement[0]

        # ---------------- Print ----------------
        print(f"{base_key} -> {sub1_key}")
        print(f"  RMSE")
        print(f"    One-step improvement : {one_step_rmse_improvement:7.2f}%")
        print(f"    Mean improvement     : {mean_rmse_improvement:7.2f}%")
        print(f"  Relative energy error")
        print(f"    One-step improvement : {one_step_energy_improvement:7.2f}%")
        print(f"    Mean improvement     : {mean_energy_improvement:7.2f}%")
        print()
