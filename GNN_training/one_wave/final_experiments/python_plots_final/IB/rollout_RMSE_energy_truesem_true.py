...
def plot_rollout_rmse_energy():
    ...
    for dt_key, cfg in RUN_DIRS.items():
        ...
        # print(f"REE SEM reference: model {dt_key} one step:", y_energy[0])
        # print(f"REE SEM reference: model {dt_key} all:", y_energy)
    ...
    out_path = RESULTS_DIR / "rmse_energy_sem_reference_raw_energy.png"
