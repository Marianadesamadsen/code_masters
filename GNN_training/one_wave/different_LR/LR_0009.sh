...
#BSUB -o GNN_training/one_wave/different_LR/output/train_0009.out
#BSUB -e GNN_training/one_wave/different_LR/output/train_0009.err
# -- end of LSF options --
