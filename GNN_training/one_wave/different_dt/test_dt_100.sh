...
#BSUB -o GNN_training/one_wave/different_dt/output/train_75_test_100.out
#BSUB -e GNN_training/one_wave/different_dt/output/train_75_test_100.err
# -- end of LSF options --
...
python -m neural_lam.train_model \
    ...
    --batch_size 1 \
    --logger-project different_training_size_test_100 \
    --eval "test" \
    --precompute_in_memory \
    --load "saved_models/train_75/min_val_loss-epoch=179-val_mean_loss=0.000154.ckpt" \
    --ar_steps_eval "100" \
    --test_time_stride 300\
    --save_eval_to_zarr_path "GNN_training/one_wave/different_dt/test_75_results_100.zarr"
