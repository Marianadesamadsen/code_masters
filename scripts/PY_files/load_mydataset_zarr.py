...
ds_train = xr.open_dataset("data/nc_files/wave_ensemble_100_coarse.nc")
ds_pred = xr.open_zarr("mydataset.zarr")
...
time_sec = np.arange(n_time)*ds_train.attrs["dt"]
...
anim = plotter.animate_sphere(norm=norm, out_path="eval_coarse_data.gif")
