...
raw_dir = r"./evaluation_results/samemesh_4nn_1mp_test/raw_preds"
plot_dir = r"./results/evaluation/plots/samemesh_4nn_test"
anim_dir = r"./results/evaluation/animations/samemesh_4nn_test"
