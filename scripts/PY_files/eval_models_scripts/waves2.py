...
# paths
ds_geo = xr.open_dataset(r"./data/nc_files/wave2_ensemble_28_waves_600_timesteps_sub4.nc")
raw_dir = r"./evaluation_results/test_initialcondition_2waves/raw_preds"
plot_dir = r"./results/waves2/plots"
anim_dir = r"./results/waves2/animations"
